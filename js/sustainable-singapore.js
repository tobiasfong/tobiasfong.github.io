...
(function () {
  ...
  var EVENTS = [
    ...
    },
    {
      ...
      img: 'maju-forest.jpg',
      body: 'On 10 July, HDB announced that they will build new homes at Gillman Barracks and Sunset Way, and it was estimated that about 15 hectares of Maju Forest at the latter and 10 hectares of forest at the former will be cleared to make way for housing. However, this sparked a public outcry, which led the government to make adjustments. Minister of State for National Development, Alvin Tan, acknowledged the ecological concerns and conceded that while they will work to preserve more greenery, it would mean fewer homes for Singaporeans.[^40]</p><p>Over a month later, on 16 August, over 1,000 people rallied in Hong Lim Park to raise their concerns over the plans to develop Maju Forest and Gillman Barracks. Organized by SG Climate Rally, participants pointed out how clearing a forest is irreversible, and asked for more transparency and public participation in decisions over land use. They also expressed their worry over the loss of forests and natural spaces.[^41]</p><p>Despite the government’s initial plans to preserve 40% of Gillman Barracks’ forests, and 35% of Maju Forest, including forest streams and ecological networks, Singaporeans remain passionate about preserving what little green space is left in Singapore.[^41] Maju Forest’s 23 hectares is 0.23 km², about 0.15% of the approximately 150 km² of forest Singapore still has. While it only makes up about 0.03% of our total land area, we should not underestimate its importance as a conservation area, and every square kilometer counts in our war against climate change.</p><p>More than three decades after the old Jurong railway shut down, its tracks became home to Maju Forest, a secondary forest that regenerated beside Clementi Forest and the Rail Corridor. It is home to many conservation-significant species, including the critically endangered straw-headed bulbul.[^42] Based on an EIA Report commissioned by NParks on behalf of HDB, the area that is now Maju Forest, next to Clementi Park, was most likely covered in rubber plantations. It was still predominantly grassland in 1950, though in 1963, the Jurong railway line was built across it, opening in 1965 and linking to the Keretapi Tanah Melayu railway that passed through Clementi Forest, which linked to Malaysia. By 1978, the area was a combination of the Jurong railway line, buildings in western low-density settlements, and abandoned land forest. After the Jurong railway line was decommissioned during the 1990s due to low usage after Singapore’s independence, it became overgrown with vegetation. Back in 2021, NParks planned to convert 4 km of the old railway into a nature trail, the Old Jurong Line Nature Trail, which would open near the end of 2026.[^43]'
    }
  ];
